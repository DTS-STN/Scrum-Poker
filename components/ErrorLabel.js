...
export function ErrorLabel(props) {
  return (
    <div
      className={`appearance-none rounded-r-lg border-l-4 border-[#D3080C] mt-2 sm:-mb-6 px-10 py-2 md:mb-0 bg-[#F3E9E8] font-body font-bold text-sm lg:text-p ${props.className}`}
      id={props.errorId}
      aria-live="polite"
